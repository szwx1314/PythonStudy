        ...
        with lnkPath.open('rb') as f:
            ...
            if (self._lnkFlags & 0x02):
                ...
                if (self._linkInfoFlags & 0x01):
                    ...
                    self._localBasePath = UnpackZ('z', content[bpPosition:])[0].decode('gbk')
                ...
                self._commonPathSuffix = UnpackZ('z', content[cmnSuffixPosition:])[0].decode('gbk')
...
#print(MSShortcut('E:/常用图标/CIS2.5-临床信息系统-122.lnk').localBasePath)
#print(MSShortcut('E:/常用图标/CIS2.5-临床信息系统-122.lnk').commandLineArgs)